/**
 * Divide o texto renderizado em seções pelas linhas `=== Título ===`.
 *
 * Portado 1:1 do gerador-os (RamonyML/gerador-os, web/src/lib/splitOsPreviewSections.ts).
 * É o que separa o output dos modelos de mud-end nos blocos Protocolo / O.S /
 * Agenda. A fidelidade dos textos depende deste split (apara o espaço final das
 * seções, ignora linhas decorativas só de "="). NÃO alterar.
 */
