          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-100 text-[18px] text-emerald-700">
                      🌾
                    </div>
                    <div>
                      <div className="text-[17px] font-semibold text-zinc-900">
                ...
                <div className="mt-4 space-y-2 text-[13px]">
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1 inline-block h-2 w-2 rounded-full bg-lime-500" />
                    <span>Endereço rural (fazenda/sítio)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1 inline-block h-2 w-2 rounded-full bg-amber-500" />
                    <span>Planos e SVA da zona rural</span>
                  </div>
                </div>
                <div className="my-4 h-px bg-zinc-100" />
                <div className="flex items-center justify-between text-[12px] text-zinc-500">
