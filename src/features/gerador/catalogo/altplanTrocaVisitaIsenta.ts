/**
 * Catálogo de frases do modelo `altplan-troca-visita-isenta`.
 *
 * Troca o roteador por um compatível com o novo plano, com visita isenta.
 * O corpo da O.S é montado em duas partes — cabeçalho + fecho — e as duas são
 * editáveis separadamente, o que dá mais granularidade do que um parágrafo
 * gigante único.
 *
...
export const ALTPLAN_TROCA_VISITA_ISENTA: Catalogo = {
  aberturaTitular: {
  ...
  compatNao: {
    rotulo: 'Roteador NÃO é compatível — precisa trocar',
    texto:
  ...
  compatSim: {
    rotulo: 'Roteador é compatível — troca por versão atualizada',
    texto:
  ...
  contratoVisita: {
    rotulo: 'Termos do contrato e necessidade de troca',
    texto:
  ...
  osFechoTitularAutorizaTerceiro: {
    ...
    texto:
      '{titular} CONCORDOU COM A VISITA, DISSE QUE NÃO ESTARÁ PRESENTE, MAS AUTORIZOU {autorizado} ({parente}) A ACOMPANHAR O TÉCNICO E ASSINAR O.S. VISITA ISENTA DE CUSTOS AGENDADA (A PEDIDO DO CLIENTE) PARA {dataVisita} ÀS {horaVisita} HRS.',
    obrigatorios: ['titular', 'dataVisita'],
  },
  osFechoTitularAcompanha: {
    rotulo: 'Fecho da O.S — titular acompanha',
    texto:
      'POR PROCEDIMENTO PADRÃO ENTREI EM CONTATO POR {canal} ({contato}) COM {titular} (ASSINANTE) QUE CONFIRMOU E AUTORIZOU A VISITA. DISSE QUE ESTARÁ PRESENTE PARA ACOMPANHAR O TÉCNICO E ASSINAR O.S. VISITA ISENTA DE CUSTOS AGENDADA PARA O DIA {dataVisita} ÀS {horaVisita} HRS.',
    obrigatorios: ['titular', 'dataVisita'],
  },
  osFechoTerceiroAutorizado: {
    rotulo: 'Fecho da O.S — terceiro autorizado a acompanhar',
    texto:
      'POR PROCEDIMENTO PADRÃO ENTREI EM CONTATO POR {canal} ({contato}) COM {titular} (ASSINANTE) QUE CONFIRMOU E AUTORIZOU {solicitanteCompleto} ({parente}) A ACOMPANHAR O TÉCNICO E ASSINAR O.S. VISITA TÉCNICA ISENTA DE CUSTOS AGENDADA PARA {dataVisita} ÀS {horaVisita} HRS.',
    obrigatorios: ['titular', 'dataVisita'],
  },
  osFechoTitular: {
    rotulo: 'Fecho da O.S — titular acompanha sozinho',
    texto: 'VISITA TÉCNICA ISENTA DE CUSTOS. VISITA AGENDADA PARA {dataVisita} ÀS {horaVisita} HRS.',
    obrigatorios: ['dataVisita', 'horaVisita'],
  },

  agenda: {
    rotulo: 'Linha da agenda',
    texto: 'ALT PLANO {clienteCompleto} PROT:{protocolo} ISENTO{operador} - {bairro}{roteadorSug}',
