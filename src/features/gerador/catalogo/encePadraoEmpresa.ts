/**
 * Catálogo de frases do modelo `ence-padrao-empresa`.
 * Texto de encerramento de instalação empresarial — um checklist do que o
 * técnico executou.
 *
...
export const ENCE_PADRAO_EMPRESA: Catalogo = {
  titulo: { rotulo: 'Título do encerramento', texto: 'PADRAO EMPRESA:', obrigatorios: [] },
  ...
  linhaOnt: { rotulo: 'Linha da ONT', texto: 'ONT {ont} MAC {macOnt} {fixacao}', obrigatorios: [] },
