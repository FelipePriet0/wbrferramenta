/**
 * Catálogo de frases do modelo `midia-roku-presencial`.
 * Compra de Roku TV — fluxo presencial.
 *
...
export const MIDIA_ROKU_PRESENCIAL: Catalogo = {
  cabecalho: {
    rotulo: 'Abertura do atendimento',
    texto: '{cliente} COMPARECEU NA LOJA E SOLICITOU A COMPRA DO ROKU-TV (CONVERSOR DE MÍDIA).',
