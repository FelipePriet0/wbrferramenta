/**
 * Catálogo de frases do modelo `wifi-extend-tplink`.
...
export const WIFI_EXTEND_TPLINK: Catalogo = {
  explicaPlanos: {
  ...
  aberturaIndicacaoComTroca: {
    ...
    texto: 'TÉCNICO: PLANO JÁ ALTERADO PARA NOVO PLANO ESCOLHIDO. CONFERIR INSTALAÇÃO E EQUIPAMENTOS EM COMODATO, NÃO HAVENDO DANOS SUBSTITUIR ROTEADOR ATUAL (PRIMÁRIO) POR ONT TPLINK. INSTALAR 2° ROTEADOR (MODELO COMPATIVEL AO PLANO)',
    obrigatorios: [],
  },
};
