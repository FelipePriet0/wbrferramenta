/**
 * Config do formulário do modelo `wifi-extend-tplink` (coluna esquerda do
 * gerador). Mesmo fluxo/builder (`Pqe`) do irmão ZTE — os campos são idênticos
 * (o porte anterior deixou só o stub de `segmento`). Ver
 * `docs/gerador/builders/wifiExtendTplink.builder.txt`.
 */
...
export const WIFI_EXTEND_TPLINK_FORM: ModeloForm = {
  slug: 'wifi-extend-tplink',
  demanda: 'wifi-extend',
  titulo: 'Wi-Fi Extend — TP-Link',
  descricao: 'Alteração de plano com Wi-Fi Extend (2º roteador em mesh), equipamento TP-Link.',
  modo: 'Wi-Fi Extend · TP-Link',
  variavelId: '',
  secoes: [
    {
