/**
 * Config do formulário do modelo `inst-taxa-empresarial` (instalação com taxa —
 * empresarial / PJ). Campos extraídos do pacote do builder legado `BZe`.
 */
...
export const INST_TAXA_EMPRESARIAL_FORM: ModeloForm = {
  slug: 'inst-taxa-empresarial',
  demanda: 'instalacao-taxa',
  titulo: 'Instalação com taxa — Empresarial',
  descricao: 'Instalação empresarial (PJ) com taxa de instalação/ativação já paga.',
  modo: 'Instalação com taxa · Empresarial (PJ)',
  ...
  secoes: [
    ...
    },
    {
      ...
      campos: [
        { id: 'cliente', label: 'Nome do proprietário da empresa', controle: 'text', placeholder: 'Proprietário', span: 6 },
        { id: 'solicitante', label: 'Nome do representante autorizado', controle: 'text', placeholder: 'Representante', span: 6 },
        { id: 'parente', label: 'Cargo / função', controle: 'text', placeholder: 'Ex.: SÓCIO, GERENTE', span: 6 },
    ...
    },
    {
      ...
      campos: [
        ...
        { id: 'plano150', label: 'Plano de acesso', controle: 'select', opcoes: PLANOS_150, span: 6, mostrarQuando: (v) => (v.filtroPlano || '150') === '150' },
        { id: 'plano300', label: 'Plano de acesso', controle: 'select', opcoes: PLANOS_300, span: 6, mostrarQuando: (v) => v.filtroPlano === '300' },
        { id: 'plano600', label: 'Plano de acesso', controle: 'select', opcoes: PLANOS_600, span: 6, mostrarQuando: (v) => v.filtroPlano === '600' },
        { id: 'plano1g', label: 'Plano de acesso', controle: 'select', opcoes: PLANOS_1G, span: 6, mostrarQuando: (v) => v.filtroPlano === '1g' },
        { id: 'planoIttv', label: 'Plano de acesso', controle: 'select', opcoes: PLANOS_ITTV, span: 6, mostrarQuando: (v) => v.filtroPlano === 'ittv' },
        ...
        { id: 'parcelas', label: 'Parcelas da taxa', controle: 'select', opcoes: PARCELAS, span: 6 },
      ],
    },
    {
      titulo: 'AGENDAMENTO',
