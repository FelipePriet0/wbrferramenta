...
import { ENCE_PADRAO_EMPRESA } from '../catalogo/encePadraoEmpresa';

/** Slug no registry — é a chave dos overrides no banco. */
const SLUG = 'ence-padrao-empresa';

const f = fraseDe(SLUG, ENCE_PADRAO_EMPRESA);
...
export function renderEncePadraoEmpresa(valores: Valores): SaidaOS {
  ...
  if (l) r += f('appProvedor', { appCelular: l, testeCobertura: c }) + `\n`;
  if (t.app_mztv === `SIM`) {
