...
type Tone = 'neutral' | 'good' | 'warn' | 'bad' | 'featured' | 'featured-secondary';
...
const TONE_BORDER: Record<Tone, string> = {
  ...
  'featured-secondary':'border-transparent',
};
...
const TONE_ICON: Record<Tone, string> = {
  ...
  'featured-secondary':'text-white bg-white/20',
};
...
const TONE_TITLE: Record<Tone, string> = {
  ...
  'featured-secondary':'text-white/80',
};
...
const TONE_SUBTITLE: Record<Tone, string> = {
  ...
  'featured-secondary':'text-white/60',
};

const TONE_GRADIENT: Partial<Record<Tone, string>> = {
  featured:            'linear-gradient(135deg, var(--color-primary) 0%, color-mix(in srgb, var(--color-primary) 55%, black) 100%)',
  'featured-secondary':'linear-gradient(135deg, #FF6600 0%, color-mix(in srgb, #FF6600 55%, black) 100%)',
};
